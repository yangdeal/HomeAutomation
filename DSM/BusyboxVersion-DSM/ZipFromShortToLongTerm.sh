...
#   1. zip the short term folder which is DAYSAFTER days older to long term, and
#   2. Send the short term folder to recycle bin, it will be delete after 7 (current setting) days

# folder structure:
# /volume1/Shared/97-motion-short-term/2015/201509/20150930/iSpy/video/

## Parameters starts here
MOUNTPOINT="/volume1/Shared"
...
echo "+++++Total `echo ${FOLDERS} | wc -w` folders proceeded"
